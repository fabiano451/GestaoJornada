...
namespace Jornada.Repository.Mapping
{
    public class AlunoConfiguration : IEntityTypeConfiguration<Aluno>
    {
        public void Configure(EntityTypeBuilder<Aluno> builder)
        {
            ...
            builder.Property(a => a.AlunoId).HasColumnName("AlunoId").HasColumnType("UNIQUEIDENTIFIER").IsRequired();
            builder.Property(a => a.Nome).HasColumnName("Nome").HasColumnType("nvarchar(100").IsRequired();
            builder.Property(a => a.CPF).HasColumnName("CPF").HasColumnType("UNIQUEIDENTIFIER").IsRequired();
            builder.Property(a => a.Email).HasColumnName("Email").HasColumnType("nvarchar(100").IsRequired();
            builder.Property(a => a.Telefone).HasColumnName("Telefone").HasColumnType("nvarchar(100").IsRequired();
